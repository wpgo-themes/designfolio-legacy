...
class PC_Portfolio_CPT {
	...
	public function register_post_type() {
		...
		$args = array(
			'public'              => true,
			'exclude_from_search' => false, // @todo Setting this to true will break the pagination for the portfolio_group custom taxonomy. See: https://core.trac.wordpress.org/ticket/17592
			'query_var'           => true,
			'rewrite'             => true,
	...
	public function portfolio_cpt_meta_box( $post, $args ) {
		...
		<table width="100%">
			...
			<tr<?php echo $hide_css; ?>>
				...
				<td>
					<input style="width:100%;" type="text" name="<?php echo PC_THEME_NAME_SLUG; ?>_portfolio_cpt_fi_link" value="<?php echo esc_attr( $portfolio_cpt_fi_link ); ?>">
				</td>
			</tr>
			<tr>
				<td width="120">Portfolio Title Link:</td>
				<td>
					<input style="width:100%;" type="text" name="<?php echo PC_THEME_NAME_SLUG; ?>_portfolio_cpt_title_link" value="<?php echo esc_attr( $portfolio_cpt_title_link ); ?>">
				</td>
			</tr>
			<tr>
				<td colspan="2">
