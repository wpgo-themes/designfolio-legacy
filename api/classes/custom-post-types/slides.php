...
class PC_Slide_CPT {
	...
	public function slide_cpt_meta_box( $post, $args ) {
		...
		<table width="100%">
			...
			<tr>
				<td colspan="3">
					<label><input id="chk_slide_cpt_show_title" type="checkbox" value="1" name="<?php echo PC_THEME_NAME_SLUG; ?>_slide_cpt_show_title" <?php checked( $slide_cpt_show_title, '1' ); ?>>&nbsp;Hide slide title</label>
				</td>
			</tr>
			...
			<tr<?php echo $hide_css; ?>>
				...
				<td>
					<input style="width:100%;" type="text" name="<?php echo PC_THEME_NAME_SLUG; ?>_slide_cpt_fi_link" value="<?php echo esc_attr( $slide_cpt_fi_link ); ?>">
				</td>
				<td width="140">
					<span style="font-style:italic;color:#666;">&nbsp;&nbsp;Leave blank for no link</span>
				</td>
