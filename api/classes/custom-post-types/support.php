...
class PC_Support_CPT {
	...
	public function register_post_type() {
		...
		$args = array(
			...
			'_builtin'            => false,
			'has_archive'         => true,
			'exclude_from_search' => false, // @todo Setting this to true will break the pagination for the slide_group custom taxonomy. See: https://core.trac.wordpress.org/ticket/17592
			'query_var'           => true,
	...
	public function support_cpt_meta_box( $post, $args ) {
		...
		<table width="100%">
			...
			<tr>
				<td>Company:</td>
				<td>
					<input style="width:100%;" type="text" name="<?php echo PC_THEME_NAME_SLUG; ?>_support_cpt_company" value="<?php echo esc_attr( $support_cpt_company ); ?>">
				</td>
			</tr>
			<tr>
				<td>Company Link:</td>
				<td>
					<input style="width:100%;" type="text" name="<?php echo PC_THEME_NAME_SLUG; ?>_support_cpt_company_url" value="<?php echo esc_attr( $support_cpt_company_url ); ?>">
				</td>
			</tr>
			<tr>
				<td width="100">Gravatar E-mail:</td>
				<td>
					<input style="width:100%;" type="text" name="<?php echo PC_THEME_NAME_SLUG; ?>_support_cpt_image" value="<?php echo esc_attr( $support_cpt_image ); ?>">
				</td>
			</tr>
			<tr>
				<td colspan="2">
					<div style="font-style:italic;color:#666;margin-top:10px;line-height:18px;">To upload an image, use the Support Image feature to the right (recommended 50x50 pixels), or enter a Gravatar e-mail above. A default icon is shown for an invalid gravatar e-mail.</div>
				</td>
			</tr>
			</tbody>
		</table>
