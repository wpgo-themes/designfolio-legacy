	...
	public function testimonial_cpt_meta_box( $post, $args ) {
		...
		<table width="100%">
			...
			<tr>
				<td>Company:</td>
				<td>
					<input style="width:100%;" type="text" name="<?php echo PC_THEME_NAME_SLUG; ?>_testimonial_cpt_company" value="<?php echo esc_attr( $testimonial_cpt_company ); ?>">
				</td>
			</tr>
			<tr>
				<td>Company Link:</td>
				<td>
					<input style="width:100%;" type="text" name="<?php echo PC_THEME_NAME_SLUG; ?>_testimonial_cpt_company_url" value="<?php echo esc_attr( $testimonial_cpt_company_url ); ?>">
				</td>
			</tr>
			<tr>
				<td width="100">Gravatar E-mail:</td>
				<td>
					<input style="width:100%;" type="text" name="<?php echo PC_THEME_NAME_SLUG; ?>_testimonial_cpt_image" value="<?php echo esc_attr( $testimonial_cpt_image ); ?>">
				</td>
			</tr>
			<tr>
				<td colspan="2">
					<div style="font-style:italic;color:#666;margin-top:10px;line-height:18px;">To upload an image, use the Testimonial Image feature to the right (recommended <?php echo $w . 'x' . $w; ?> pixels), or enter a Gravatar e-mail above. A default icon is shown for an invalid gravatar e-mail.</div>
				</td>
			</tr>
			</tbody>
		</table>
	...
	public function testimonial_cpt_sc_meta_box( $post, $args ) {
		...
		<table width="100%">
			...
			<tr>
				...
				<td>
					<input style="width:100%;font-family: Courier New;" type="text" name="<?php echo PC_THEME_NAME_SLUG; ?>_testimonial_cpt_sc" value="<?php echo $sc; ?>">
				</td>
			</tr>
			<tr>
				<td colspan="2">
					<div style="font-style:italic;color:#666;margin-top:10px;line-height:18px;">Copy and paste the above shortcode into any post/page to display this individual testimonial.</div>
				</td>
			</tr>
			</tbody>
		</table>
