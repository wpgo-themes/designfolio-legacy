...
class PC_SidebarCommander {
	...
	public function widgets_page_form() {
		...
		<div id="custom_widget_form_container" style="display:none;">
			<form id="add_new_widget_area" name="presscoders_widget_options_form" method="post" action="options.php">
				...
				<div class="sc_container">
					...
					<div>
						...
						<label><?php _e( 'Name', 'presscoders' ); ?>:
							<input id="widget_area_txt_input" name="new_widget_area_label" type='text' /></label>

						<div id="custom-widgets-width-trigger"><a>[+] <em><?php _e( 'Options', 'presscoders' ); ?></em></a>
						</div>
			...
			<!-- custom widget form closing tag -->
	...
	public function register_extra_widget_areas() {
		...
		if ( ! is_array( $options ) ) {
			return;
		} // Just return if theme options array not initialized yet
