		...
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="post-content">
				...
				if ( get_post()->post_excerpt )
					echo '<p>' . get_the_excerpt() . '<br><a href="' . get_permalink() . '#more-' . get_the_ID() . '" class="button more-link">' . $args['read_more'] . '</a></p>';
				else
		...
		<?php if ( have_posts() ) : ?>
			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<h2 class="entry-title"><a href="<?php the_permalink(); ?>" rel="bookmark"><?php echo $title; ?></a>
					</h2>
