...
class pc_blog_style_recent_posts_widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'pc_blog_style_recent_posts_widget_' . PC_THEME_NAME_SLUG, __( 'Blog Style Recent Posts', 'presscoders' ), $widget_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			<label><input type="checkbox" value="1" <?php checked( $show_post_thumbs, '1' ); ?> name="<?php echo $this->get_field_name( 'show_post_thumbs' ); ?>" />&nbsp;<?php _e( 'Show Post Thumbnails?', 'presscoders' ) ?>
			</label></p>
	<?php
	}
