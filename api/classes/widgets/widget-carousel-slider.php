...
class pc_carousel_slider_widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'pc_carousel_slider_widget_' . PC_THEME_NAME_SLUG, __( 'Carousel Slider', 'presscoders' ), $widget_ops );
	}
	...
	function form( $instance ) {
		...
		<div style="margin-bottom:2px;">
			<label for="<?php echo $this->get_field_id( 'portfolio_groups' ); ?>"><?php _e( 'Choose portfolio group:', 'presscoders' ); ?></label>
		</div>
		<?php
		$args = array(
