...
class pc_color_scheme_switcher_widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'pc_color_scheme_switcher_widget_' . PC_THEME_NAME_SLUG, __( 'Color Switcher', 'presscoders' ), $widget_ops );
	}
	...
	function form( $instance ) {
		...
		<p><?php _e( 'Description', 'presscoders' ) ?>:
			<textarea class="widefat" name="<?php echo $this->get_field_name( 'description' ); ?>" rows="4"><?php echo esc_attr( $description ); ?></textarea>
		</p>
	<?php
	}
