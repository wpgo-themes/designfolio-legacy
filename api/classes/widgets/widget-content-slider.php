...
class pc_content_slider_widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'pc_content_slider_widget_' . PC_THEME_NAME_SLUG, __( 'Content Slider', 'presscoders' ), $widget_ops );
	}
	...
	function form( $instance ) {
		...
		<div style="margin-bottom:2px;">
			<label for="<?php echo $this->get_field_id( 'slider_groups' ); ?>"><?php _e( 'Choose slide group:', 'presscoders' ); ?></label>
		</div>
		<?php
		$args = array(
		...
		<label><input type="checkbox" value="1" <?php checked( $animation_loop, '1' ); ?> name="<?php echo $this->get_field_name( 'animation_loop' ); ?>" />&nbsp;<?php _e( 'Loop Slides', 'presscoders' ) ?>
		</label>
