...
class pc_info_box_font_icons_widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'pc_info_widget_fi_' . PC_THEME_NAME_SLUG, __( 'Info Box', 'presscoders' ), $widget_ops );
	}
		...
		<div class="scroll">
			<table cellpadding="0" cellspacing="0">
				<tr>
					...
					<td>
						<input style="width:100%;" name="<?php echo $this->get_field_name( 'facebook_url' ); ?>" type="text" value="<?php echo esc_attr( $facebook_url ); ?>" />
					</td>
				...
				<tr>
					...
					<td>
						<input style="width:100%;" name="<?php echo $this->get_field_name( 'twitter_url' ); ?>" type="text" value="<?php echo esc_attr( $twitter_url ); ?>" />
					</td>
				...
				<tr>
					...
					<td>
						<input style="width:100%;" name="<?php echo $this->get_field_name( 'youtube_url' ); ?>" type="text" value="<?php echo esc_attr( $youtube_url ); ?>" />
					</td>
				...
				<tr>
					...
					<td>
						<input style="width:100%;" name="<?php echo $this->get_field_name( 'flickr_url' ); ?>" type="text" value="<?php echo esc_attr( $flickr_url ); ?>" />
					</td>
				...
				<tr>
					...
					<td>
						<input style="width:100%;" name="<?php echo $this->get_field_name( 'pinterest_url' ); ?>" type="text" value="<?php echo esc_attr( $pinterest_url ); ?>" />
					</td>
				...
				<tr>
					...
					<td>
						<input style="width:100%;" name="<?php echo $this->get_field_name( 'googleplus_url' ); ?>" type="text" value="<?php echo esc_attr( $googleplus_url ); ?>" />
					</td>
				...
				<tr>
					...
					<td>
						<input style="width:100%;" name="<?php echo $this->get_field_name( 'linkedin_url' ); ?>" type="text" value="<?php echo esc_attr( $linkedin_url ); ?>" />
					</td>
				...
				<tr>
					...
					<td>
						<input style="width:100%;" name="<?php echo $this->get_field_name( 'rss_url' ); ?>" type="text" value="<?php echo esc_attr( $rss_url ); ?>" />
					</td>
	...
	function widget( $args, $instance ) {
		...
		if ( ! empty( $info_description ) ) {
			echo '<p class="info_description">' . $info_description . '</p>';
		}
		if ( ! empty( $phone_number ) ) {
			echo '<span class="phone"><i class="icon-phone"></i><a href="tel:' . $phone_number . '">' . $phone_number . '</a></span>';
		}
		if ( ! empty( $facebook_url ) ) {
			echo '<a href="' . $facebook_url . '" target="_blank" class="sm-icon fb"><p>F</p></a>';
		}
		if ( ! empty( $twitter_url ) ) {
			echo '<a href="' . $twitter_url . '" target="_blank" class="sm-icon tw"><p>L</p></a>';
		}
		if ( ! empty( $youtube_url ) ) {
			echo '<a href="' . $youtube_url . '" target="_blank" class="sm-icon yt"><p>X</p></a>';
		}
		if ( ! empty( $flickr_url ) ) {
			echo '<a href="' . $flickr_url . '" target="_blank" class="sm-icon fr"><p>N</p></a>';
		}
		if ( ! empty( $pinterest_url ) ) {
			echo '<a href="' . $pinterest_url . '" target="_blank" class="sm-icon pin"><p>:</p></a>';
		}
		if ( ! empty( $googleplus_url ) ) {
			echo '<a href="' . $googleplus_url . '" target="_blank" class="sm-icon google"><p>G</p></a>';
		}
		if ( ! empty( $linkedin_url ) ) {
			echo '<a href="' . $linkedin_url . '" target="_blank" class="sm-icon linkedin"><p>I</p></a>';
		}
		if ( ! empty( $rss_url ) ) {
			echo '<a href="' . $rss_url . '" target="_blank" class="sm-icon rss"><p>R</p></a>';
		}
