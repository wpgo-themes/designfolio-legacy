...
class pc_info_box_widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'pc_info_widget_' . PC_THEME_NAME_SLUG, __( 'Info Box', 'presscoders' ), $widget_ops );
	}
	...
	function form( $instance ) {
		...
		<div class="scroll">
			<table cellpadding="0" cellspacing="0">
				<tr>
					<td>
						<img src="<?php echo PC_Utility::theme_resource_uri( array( 'images/', 'api/images/icons/' ), 'facebook.png', 'images/' ); ?>" width="24" height="24" alt="Facebook" />
					</td>
					<td>
						<input style="width:100%;" name="<?php echo $this->get_field_name( 'facebook_id' ); ?>" type="text" value="<?php echo esc_attr( $facebook_id ); ?>" />
					</td>
					<td style="width:73px;font-size:11px;">&nbsp;<?php _e( 'Facebook ID', 'presscoders' ) ?></td>
				</tr>
				<tr>
					<td>
						<img src="<?php echo PC_Utility::theme_resource_uri( array( 'images/', 'api/images/icons/' ), 'twitter.png', 'images/' ); ?>" width="24" height="24" alt="Twitter" />
					</td>
					<td>
						<input style="width:100%;" name="<?php echo $this->get_field_name( 'twitter_id' ); ?>" type="text" value="<?php echo esc_attr( $twitter_id ); ?>" />
					</td>
					<td style="font-size:11px;">&nbsp;<?php _e( 'Twitter ID', 'presscoders' ) ?></td>
				</tr>
				<tr>
					<td>
						<img src="<?php echo PC_Utility::theme_resource_uri( array( 'images/', 'api/images/icons/' ), 'youtube.png', 'images/' ); ?>" width="24" height="24" alt="YouTube" />
					</td>
					<td>
						<input style="width:100%;" name="<?php echo $this->get_field_name( 'youtube_id' ); ?>" type="text" value="<?php echo esc_attr( $youtube_id ); ?>" />
					</td>
					<td style="font-size:11px;">&nbsp;<?php _e( 'YouTube ID', 'presscoders' ) ?></td>
				</tr>
				<tr>
					<td>
						<img src="<?php echo PC_Utility::theme_resource_uri( array( 'images/', 'api/images/icons/' ), 'flickr.png', 'images/' ); ?>" width="24" height="24" alt="Flickr" />
					</td>
					<td>
						<input style="width:100%;" name="<?php echo $this->get_field_name( 'flickr_id' ); ?>" type="text" value="<?php echo esc_attr( $flickr_id ); ?>" />
					</td>
					<td style="font-size:11px;">&nbsp;<?php _e( 'Flickr ID', 'presscoders' ) ?></td>
				</tr>
				<tr>
					<td>
						<img src="<?php echo PC_Utility::theme_resource_uri( array( 'images/', 'api/images/icons/' ), 'pinterest.png', 'images/' ); ?>" width="24" height="24" alt="Pinterest" />
					</td>
					<td>
						<input style="width:100%;" name="<?php echo $this->get_field_name( 'pinterest_id' ); ?>" type="text" value="<?php echo esc_attr( $pinterest_id ); ?>" />
					</td>
					<td style="font-size:11px;">&nbsp;<?php _e( 'Pinterest ID', 'presscoders' ) ?></td>
				</tr>
				<tr>
					<td>
						<img src="<?php echo PC_Utility::theme_resource_uri( array( 'images/', 'api/images/icons/' ), 'googleplus.png', 'images/' ); ?>" width="24" height="24" alt="Google+" />
					</td>
					<td>
						<input style="width:100%;" name="<?php echo $this->get_field_name( 'googleplus_id' ); ?>" type="text" value="<?php echo esc_attr( $googleplus_id ); ?>" />
					</td>
					<td style="font-size:11px;">&nbsp;<?php _e( 'Google+ URL', 'presscoders' ) ?></td>
				</tr>
				<tr>
					<td>
						<img src="<?php echo PC_Utility::theme_resource_uri( array( 'images/', 'api/images/icons/' ), 'linkedin.png', 'images/' ); ?>" width="24" height="24" alt="Linked In" />
					</td>
					<td>
						<input style="width:100%;" name="<?php echo $this->get_field_name( 'linkedin_id' ); ?>" type="text" value="<?php echo esc_attr( $linkedin_id ); ?>" />
					</td>
					<td style="font-size:11px;">&nbsp;<?php _e( 'Linked In URL', 'presscoders' ) ?></td>
				</tr>
				<tr>
					<td>
						<img src="<?php echo PC_Utility::theme_resource_uri( array( 'images/', 'api/images/icons/' ), 'rss.png', 'images/' ); ?>" width="24" height="24" alt="RSS" />
					</td>
					<td>
						<input style="width:100%;" name="<?php echo $this->get_field_name( 'rss_id' ); ?>" type="text" value="<?php echo esc_attr( $rss_id ); ?>" />
					</td>
		...
		<p>
			<label for="<?php echo $this->get_field_name( 'custom_img_1' ); ?>"><?php _e( 'Image URL', 'presscoders' ) ?>
				<em>(32 x 32 pixels)</em></label>
	...
	function widget( $args, $instance ) {
		...
		if ( ! empty( $facebook_id ) ) {
			echo '<a href="https://www.facebook.com/' . $facebook_id . '" target="_blank" class="sm-icon"><img src="' . PC_Utility::theme_resource_uri( array( 'images/', 'api/images/icons/' ), 'facebook.png', 'images/' ) . '" width="32" height="32" alt="Facebook" /></a>';
		}
		if ( ! empty( $twitter_id ) ) {
			echo '<a href="https://twitter.com/' . $twitter_id . '" target="_blank" class="sm-icon"><img src="' . PC_Utility::theme_resource_uri( array( 'images/', 'api/images/icons/' ), 'twitter.png', 'images/' ) . '" width="32" height="32" alt="Twitter" /></a>';
		}
		if ( ! empty( $youtube_id ) ) {
			echo '<a href="https://www.youtube.com/user/' . $youtube_id . '" target="_blank" class="sm-icon"><img src="' . PC_Utility::theme_resource_uri( array( 'images/', 'api/images/icons/' ), 'youtube.png', 'images/' ) . '" width="32" height="32" alt="YouTube" /></a>';
		}
		if ( ! empty( $flickr_id ) ) {
			echo '<a href="https://www.flickr.com/photos/' . $flickr_id . '" target="_blank" class="sm-icon"><img src="' . PC_Utility::theme_resource_uri( array( 'images/', 'api/images/icons/' ), 'flickr.png', 'images/' ) . '" width="32" height="32" alt="Flickr" /></a>';
		}
		if ( ! empty( $pinterest_id ) ) {
			echo '<a href="https://pinterest.com/' . $pinterest_id . '" target="_blank" class="sm-icon"><img src="' . PC_Utility::theme_resource_uri( array( 'images/', 'api/images/icons/' ), 'pinterest.png', 'images/' ) . '" width="32" height="32" alt="Pinterest" /></a>';
		}
