...
class pc_nivo_slider_widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'pc_nivo_slider_widget_' . PC_THEME_NAME_SLUG, __( 'Nivo Slider', 'presscoders' ), $widget_ops );
	}
	...
	function form( $instance ) {
		...
		<label><input type="radio" value="post_featured_item" <?php checked( 'post_featured_item', $featured_item_type ); ?> name="<?php echo $this->get_field_name( 'featured_item_type' ); ?>" /> <?php _e( 'Posts (category)', 'presscoders' ); ?>
		</label><br />
		<label><input type="radio" value="page_featured_item" <?php checked( 'page_featured_item', $featured_item_type ); ?> name="<?php echo $this->get_field_name( 'featured_item_type' ); ?>" /> <?php _e( 'Pages (page parent)', 'presscoders' ); ?>
		</label><br />
		<label><input type="radio" value="image_featured_item" <?php checked( 'image_featured_item', $featured_item_type ); ?> name="<?php echo $this->get_field_name( 'featured_item_type' ); ?>" /> <?php _e( 'Media Libray Image ID\'s', 'presscoders' ); ?>
		</label><br />
		<label><input type="radio" value="id_featured_item" <?php checked( 'id_featured_item', $featured_item_type ); ?> name="<?php echo $this->get_field_name( 'featured_item_type' ); ?>" /> <?php _e( 'Individual Post/Page ID\'s', 'presscoders' ); ?>
		</label>

		<p style="margin-top:8px;"><?php _e( 'Post category', 'presscoders' ); ?>: <?php $args = array( 'show_option_all' => 'All Categories', 'id' => $this->get_field_id( 'nivo_posts_category' ), 'hide_empty' => 0, 'hierarchical' => 0, 'show_count' => 0, 'name' => $this->get_field_name( 'nivo_posts_category' ), 'selected' => $instance['nivo_posts_category'] );
			wp_dropdown_categories( $args ); ?></p>

		<p style="margin-top:8px;"><?php _e( 'Page parent', 'presscoders' ); ?>: <?php $args = array( 'depth' => 1, 'name' => $this->get_field_name( 'nivo_pages_parent' ), 'selected' => $instance['nivo_pages_parent'] );
			wp_dropdown_pages( $args ); ?></p>

		<p style="margin-top:8px;">
			<label for="<?php echo $this->get_field_id( 'nivo_images_list' ); ?>"><?php _e( 'Add media library image ID\'s:', 'presscoders' ); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'nivo_images_list' ); ?>" name="<?php echo $this->get_field_name( 'nivo_images_list' ); ?>" type="text" value="<?php echo $nivo_images_list; ?>" />
		</p>

		<p style="margin-top:8px;">
			<label for="<?php echo $this->get_field_id( 'nivo_id_list' ); ?>"><?php _e( 'Enter list of Post/Page ID\'s:', 'presscoders' ); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'nivo_id_list' ); ?>" name="<?php echo $this->get_field_name( 'nivo_id_list' ); ?>" type="text" value="<?php echo $nivo_id_list; ?>" />
		</p>

		<p id="nivo-slider-trigger-<?php echo $this->number; ?>" style="cursor:pointer;font-size:1em;"><a>[+]
				<span style="font-style:italic;"><?php _e( 'Advanced Options', 'presscoders' ); ?></span></a></p>
		...
		<div id="nivo-slider-toggle-<?php echo $this->number; ?>">
			...
			<table>
				<tr>
					<td>
						<label for="<?php echo $this->get_field_id( 'featured_slider_items' ); ?>"><?php _e( 'Featured Items (max)', 'presscoders' ); ?>:&nbsp;&nbsp;</label>
					</td>
					<td>
						<input id="<?php echo $this->get_field_id( 'featured_slider_items' ); ?>" name="<?php echo $this->get_field_name( 'featured_slider_items' ); ?>" type="text" value="<?php echo $featured_slider_items; ?>" size="4" />
					</td>
				</tr>
				<tr>
					<td>
						<label for="<?php echo $this->get_field_id( 'overlay_opacity' ); ?>"><?php _e( 'Overlay Opacity', 'presscoders' ); ?>:</label>
					</td>
					<td>
						<input id="<?php echo $this->get_field_id( 'overlay_opacity' ); ?>" name="<?php echo $this->get_field_name( 'overlay_opacity' ); ?>" type="text" value="<?php echo $overlay_opacity; ?>" size="4" />
					</td>
				</tr>
				<tr>
					<td>
						<label for="<?php echo $this->get_field_id( 'anim_speed' ); ?>"><?php _e( 'Transition Speed', 'presscoders' ); ?>:</label>
					</td>
					<td>
						<input id="<?php echo $this->get_field_id( 'anim_speed' ); ?>" name="<?php echo $this->get_field_name( 'anim_speed' ); ?>" type="text" value="<?php echo $anim_speed; ?>" size="4" />
					</td>
				</tr>
				<tr>
					<td>
						<label for="<?php echo $this->get_field_id( 'pause_speed' ); ?>"><?php _e( 'Pause Time', 'presscoders' ); ?>:</label>
					</td>
					<td>
						<input id="<?php echo $this->get_field_id( 'pause_speed' ); ?>" name="<?php echo $this->get_field_name( 'pause_speed' ); ?>" type="text" value="<?php echo $pause_speed; ?>" size="4" />
					</td>
				</tr>
			</table>
