...
class pc_testimonial_widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops  = array( 'classname' => 'pc_testimonial_widget',
		                      'description' => __( 'Showcase customer testimonials. e.g. [testimonial name="John Smith" company="Acme Inc."]..[/testimonial]', 'presscoders' )
		);
		$control_ops = array( 'width' => 270 );
		parent::__construct( 'pc_testimonial_widget_' . PC_THEME_NAME_SLUG, __( 'Testimonials', 'presscoders' ), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<p><?php _e( 'Testimonial Shortcodes', 'presscoders' ) ?>:
			<textarea class="widefat" name="<?php echo $this->get_field_name( 'testimonial_shortcodes' ); ?>" rows="8" cols="12"><?php echo esc_attr( $testimonial_shortcodes ); ?></textarea>
		</p>
	<?php
	}
