...
class pc_tml_widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'pc_tml_widget_' . PC_THEME_NAME_SLUG,
			__( 'Testimonials', 'presscoders' ),
			array(
				'classname' => 'pc_tml_widget',
				'description' => __( 'Display a list of testimonials by group.', 'presscoders' )
			)
		);
	}
	...
	function form( $instance ) {
		...
		<div style="margin-bottom:1px;">
			<label for="<?php echo $this->get_field_id( 'tml_groups' ); ?>"><?php _e( 'Display testimonial group:', 'presscoders' ); ?></label>
		</div>
		<?php
		$category_args = array(
