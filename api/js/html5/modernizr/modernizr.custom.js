 ...
 * Build: http://www.modernizr.com/download/#-borderradius-boxshadow-opacity-rgba-textshadow-generatedcontent-iepp-cssclasses-teststyles-testprop-testallprops-prefixes-domprefixes-load
 */
;
window.Modernizr = function (a, b, c) {
	...
	}([, ['#generatedcontent:after{content:"', m, '";visibility:hidden}'].join("")], [, "generatedcontent"]);
	q.rgba = function () {
