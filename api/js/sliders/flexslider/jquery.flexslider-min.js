...
(function (d) {
	d.flexslider = function (i, k) {
		var a = d(i), c = d.extend({}, d.flexslider.defaults, k), e = c.namespace, p = "ontouchstart"in window || window.DocumentTouch && document instanceof DocumentTouch, s = p ? "touchend" : "click", l = "vertical" === c.direction, m = c.reverse, h = 0 < c.itemWidth, q = "fade" === c.animation, r = "" !== c.asNavFor, g = {};
		...
		g = {init           : function () {
			...
			if (1 < a.pagingCount)for (var n = 0; n < a.pagingCount; n++)f = "thumbnails" === c.controlNav ? '<img src="' + a.slides.eq(n).attr("data-thumb") +
				'"/>' : "<a>" + b + "</a>", a.controlNavScaffold.append("<li>" + f + "</li>"), b++;
			a.controlsContainer ? d(a.controlsContainer).append(a.controlNavScaffold) : a.append(a.controlNavScaffold);
			g.controlNav.set();
			g.controlNav.active();
			a.controlNavScaffold.delegate("a, img", s, function (b) {
				b.preventDefault();
				var b = d(this), f = a.controlNav.index(b);
			...
			function b(b) {
				j =
					l ? d - b.touches[0].pageY : d - b.touches[0].pageX;
			...
			function f() {
				if (a.animatingTo === a.currentSlide && !p && null !== j) {
					...
					a.canAdvance(l) && (550 > Number(new Date) - k && 20 < Math.abs(h) ||
			...
			var f = d(c.sync).data("flexslider"), e = a.animatingTo;
			switch (b) {
				case "animate":
			...
			if (!a.animating && (a.canAdvance(b) ||
				...
				if (q)a.slides.eq(a.currentSlide).fadeOut(c.animationSpeed, c.easing), a.slides.eq(b).fadeIn(c.animationSpeed, c.easing, a.wrapup); else {
					...
					h ? (b = c.itemWidth > a.w ? 2 * c.itemMargin : c.itemMargin,
						b = (a.itemW + b) * a.move * a.animatingTo, b = b > a.limit && 1 !== a.visible ? a.limit : b) : b = 0 === a.currentSlide && b === a.count - 1 && c.animationLoop && "next" !== a.direction ? m ? (a.count + a.cloneOffset) * o : 0 : a.currentSlide === a.last && 0 === b && c.animationLoop && "prev" !== a.direction ? m ? 0 : (a.count + 1) * o : m ? (a.count - 1 - b + a.cloneOffset) * o : (b + a.cloneOffset) * o;
		...
		a.canAdvance = function (b) {
			...
			return r && 0 === a.currentItem && b === a.pagingCount - 1 && "next" !== a.direction ? !1 : b === a.currentSlide && !r ? !1 : c.animationLoop ? !0 : a.atEnd && 0 === a.currentSlide && b === f &&
		...
		a.setProps = function (b, f, d) {
			...
			e = -1 * function () {
				...
				switch (f) {
					case "setTotal":
						return m ?
							(a.count - 1 - a.currentSlide + a.cloneOffset) * b : (a.currentSlide + a.cloneOffset) * b;
					case "setTouch":
						return b;
					case "jumpEnd":
		...
		a.setup = function (b) {
			if (q)a.slides.css({width: "100%", "float": "left", marginRight: "-100%",
				position             : "relative"}), "init" === b && a.slides.eq(a.currentSlide).fadeIn(c.animationSpeed, c.easing), c.smoothHeight && g.smoothHeight(); else {
				var f, n;
				...
				l && !h ? (a.container.height(200 * (a.count + a.cloneCount) + "%").css("position", "absolute").width("100%"), setTimeout(function () {
					...
					a.setProps(f * a.computedW, "init"), setTimeout(function () {
					a.doMath();
		...
		a.doMath = function () {
			var b = a.slides.first(), f = c.itemMargin, d = c.minItems, e = c.maxItems;
			a.w = a.width();
			a.h = b.height();
			a.boxPadding = b.outerWidth() - b.width();
			h ? (a.itemT = c.itemWidth + f, a.minW = d ? d * a.itemT : a.w, a.maxW = e ? e * a.itemT : a.w, a.itemW =
		...
		a.update = function (b, d) {
			a.doMath();
			h || (b < a.currentSlide ? a.currentSlide +=
				1 : b <= a.currentSlide && 0 !== b && (a.currentSlide -= 1), a.animatingTo = a.currentSlide);
			if (c.controlNav && !a.manualControls)if ("add" === d && !h || a.pagingCount > a.controlNav.length)g.controlNav.update("add"); else if ("remove" === d && !h || a.pagingCount < a.controlNav.length)h && a.currentSlide > a.last && (a.currentSlide -= 1, a.animatingTo -= 1), g.controlNav.update("remove", a.last);
			c.directionNav && g.directionNav.update()
		};
		a.addSlide = function (b, f) {
			...
			a.count += 1;
			a.last = a.count - 1;
			l && m ? void 0 !== f ? a.slides.eq(a.count - f).after(e) :
				a.container.prepend(e) : void 0 !== f ? a.slides.eq(f).before(e) : a.container.append(e);
			a.update(f, "add");
	...
	d.fn.flexslider = function (i) {
		...
		switch (i) {
			...
			case "pause":
				...
				break;
			case "next":
				k.flexAnimate(k.getTarget("next"),
					!0);
				break;
			case "prev":
			case "previous":
