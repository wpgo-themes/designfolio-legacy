		...
		if (typeof options === "object") {
			...
			switch (options) {
				...
				case "pause":
					...
					break;
				case "next":
					$slider.flexAnimate($slider.getTarget("next"), options.pauseOnAction);
					break;
				case "prev":
				case "previous":
					$slider.flexAnimate($slider.getTarget("prev"), options.pauseOnAction);
					break;
				default:
					if (typeof options === "number") $slider.flexAnimate(options);
			}
		}
	}
