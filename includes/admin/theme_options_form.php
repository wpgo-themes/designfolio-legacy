<div class="wrap pc_settings">
	...
	<h2 class="options-title">Designfolio Pro Theme Options</h2>

	<div id="pc-buttons">
		<a class="button-secondary pc-lower" href="https://www.presscoders.com/designfolio-setup" target="_blank">Theme Setup Tutorials</a>
		<a class="button-secondary pc-lower" href="https://www.presscoders.com/contact/" target="_blank">Support</a>
	...
	<form name="<?php echo PC_THEME_NAME_SLUG; ?>_options_form" method="post" action="options.php">
		...
		<div id="pc-options-wrap">
			...
			<div class="rtoptions">
				...
				<div><?php _e( 'Current active favicon image:', 'presscoders' ); ?>
					<img src="<?php echo $favicon; ?>" width="16" height="16" /></div>
			</div>
			<!-- .rtoptions -->
			...
			<div class="rtoptions">
				...
				<div class="box">
					<label><input name="<?php echo PC_OPTIONS_DB_NAME; ?>[chk_show_social_buttons]" type="checkbox" value="1" class="alignleft" <?php if ( isset( $options['chk_show_social_buttons'] ) ) {
							checked( '1', $options['chk_show_social_buttons'] );
						} ?> /><?php _e( 'Show Twitter/Facebook Buttons?', 'presscoders' ); ?></label>
				</div>
